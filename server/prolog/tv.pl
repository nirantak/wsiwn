...
t_seasons("The Flash", 5).
t_status("The Flash", airing).

series("Once Upon a Time").
t_language("Once Upon a Time", english).
t_genre("Once Upon a Time", adventure).
t_duration("Once Upon a Time", avg).
t_seasons("Once Upon a Time", 7).
t_status("Once Upon a Time", ended).
...
series("The Block").
t_language("The Block", english).
t_genre("The Block", game-show).
t_duration("The Block", avg).
t_seasons("The Block", 13).
t_status("The Block", airing).
...
t_language("Dragon Ball Z", english).
t_genre("Dragon Ball Z", animation).
t_duration("Dragon Ball Z", short).
t_seasons("Dragon Ball Z", 15).
t_status("Dragon Ball Z", ended).
...
series("Twin Peaks").
t_language("Twin Peaks", english).
t_genre("Twin Peaks", crime).
t_duration("Twin Peaks", avg).
t_seasons("Twin Peaks", 2).
t_status("Twin Peaks", ended).

series("Smallville").
t_language("Smallville", english).
t_genre("Smallville", adventure).
t_duration("Smallville", avg).
t_seasons("Smallville", 10).
t_status("Smallville", ended).

series("Elementary").
t_language("Elementary", english).
t_genre("Elementary", crime).
t_duration("Elementary", avg).
t_seasons("Elementary", 7).
t_status("Elementary", airing).
...
t_language("The Haunting of Hill House", english).
t_genre("The Haunting of Hill House", horror).
t_duration("The Haunting of Hill House", avg).
t_seasons("The Haunting of Hill House", 1).
t_status("The Haunting of Hill House", airing).

series("Black Lightning").
t_language("Black Lightning", english).
t_genre("Black Lightning", action).
t_duration("Black Lightning", avg).
t_seasons("Black Lightning", 2).
t_status("Black Lightning", airing).
...
series("Titans").
t_language("Titans", english).
t_genre("Titans", action).
t_duration("Titans", avg).
t_seasons("Titans", 1).
t_status("Titans", airing).
...
series("Full House").
t_language("Full House", english).
t_genre("Full House", comedy).
t_duration("Full House", short).
t_seasons("Full House", 8).
t_status("Full House", ended).
...
series("Sherlock").
t_language("Sherlock", english).
t_genre("Sherlock", crime).
t_duration("Sherlock", long).
t_seasons("Sherlock", 4).
t_status("Sherlock", airing).
...
t_seasons("Karenjit Kaur - The Untold Story of Sunny Leone", 2).
...
series("Narcos").
t_language("Narcos", english).
t_genre("Narcos", biography).
t_duration("Narcos", avg).
t_seasons("Narcos", 4).
t_status("Narcos", ended).
...
t_seasons("Marvel's Agents of S.H.I.E.L.D.: Academy", n/a).
t_status("Marvel's Agents of S.H.I.E.L.D.: Academy", ended).

series("The Expanse").
t_language("The Expanse", english).
t_genre("The Expanse", drama).
t_duration("The Expanse", avg).
t_seasons("The Expanse", 3).
t_status("The Expanse", airing).

series("Mickey Mouse").
t_language("Mickey Mouse", english).
t_genre("Mickey Mouse", animation).
t_duration("Mickey Mouse", short).
t_seasons("Mickey Mouse", 4).
t_status("Mickey Mouse", airing).
...
series("Lore").
t_language("Lore", english).
t_genre("Lore", documentary).
t_duration("Lore", avg).
t_seasons("Lore", 2).
t_status("Lore", airing).
...
series("A Guy, a Girl, and Their Monster").
t_language("A Guy, a Girl, and Their Monster", english).
t_genre("A Guy, a Girl, and Their Monster", comedy).
t_duration("A Guy, a Girl, and Their Monster", avg).
t_seasons("A Guy, a Girl, and Their Monster", n/a).
t_status("A Guy, a Girl, and Their Monster", airing).
...
t_language("Lethal Weapon", english).
t_genre("Lethal Weapon", action).
t_duration("Lethal Weapon", avg).
t_seasons("Lethal Weapon", 3).
t_status("Lethal Weapon", airing).
...
t_language("My Hero Academia", japanese).
t_genre("My Hero Academia", animation).
t_duration("My Hero Academia", short).
t_seasons("My Hero Academia", 3).
t_status("My Hero Academia", airing).

series("This Is Us").
t_language("This Is Us", english).
t_genre("This Is Us", comedy).
t_duration("This Is Us", avg).
t_seasons("This Is Us", 3).
t_status("This Is Us", airing).
...
t_language("Stranger Things", english).
t_genre("Stranger Things", drama).
t_duration("Stranger Things", avg).
t_seasons("Stranger Things", 3).
t_status("Stranger Things", airing).
...
t_language("How I Met Your Mother", english).
t_genre("How I Met Your Mother", comedy).
t_duration("How I Met Your Mother", short).
t_seasons("How I Met Your Mother", 9).
t_status("How I Met Your Mother", ended).

series("DuckTales").
t_language("DuckTales", english).
t_genre("DuckTales", animation).
t_duration("DuckTales", short).
t_seasons("DuckTales", 4).
t_status("DuckTales", ended).
...
t_language("House of Cards", english).
t_genre("House of Cards", drama).
t_duration("House of Cards", avg).
t_seasons("House of Cards", 6).
t_status("House of Cards", ended).

series("Making a Murderer").
t_language("Making a Murderer", english).
t_genre("Making a Murderer", documentary).
t_duration("Making a Murderer", avg).
t_seasons("Making a Murderer", 2).
t_status("Making a Murderer", airing).
...
series("Blindspot").
t_language("Blindspot", english).
t_genre("Blindspot", action).
t_duration("Blindspot", avg).
t_seasons("Blindspot", 3).
t_status("Blindspot", airing).
...
t_language("Star Trek: The Next Generation", english).
t_genre("Star Trek: The Next Generation", action).
t_duration("Star Trek: The Next Generation", avg).
t_seasons("Star Trek: The Next Generation", 7).
t_status("Star Trek: The Next Generation", ended).

series("Mindhunter").
t_language("Mindhunter", english).
t_genre("Mindhunter", crime).
t_duration("Mindhunter", avg).
t_seasons("Mindhunter", 2).
t_status("Mindhunter", airing).
...
series("Black-ish").
t_language("Black-ish", english).
t_genre("Black-ish", comedy).
t_duration("Black-ish", short).
t_seasons("Black-ish", 5).
t_status("Black-ish", airing).

series("Dark Shadows").
t_language("Dark Shadows", english).
t_genre("Dark Shadows", drama).
t_duration("Dark Shadows", short).
t_seasons("Dark Shadows", 1).
t_status("Dark Shadows", ended).
...
series("Charmed").
t_language("Charmed", english).
t_genre("Charmed", drama).
t_duration("Charmed", avg).
t_seasons("Charmed", 8).
t_status("Charmed", ended).

series("The Handmaid's Tale").
t_language("The Handmaid's Tale", english).
t_genre("The Handmaid's Tale", drama).
t_duration("The Handmaid's Tale", avg).
t_seasons("The Handmaid's Tale", 2).
t_status("The Handmaid's Tale", airing).
